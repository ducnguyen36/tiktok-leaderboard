...
const HEADERS = {
    ...
    'faction-id': '100579',
    'priority': 'u=1, i',
    'referer': 'https://live-backstage.tiktok.com/portal/anchor/detail?activeTab=videos&enter_from=anchor_list_page&username=kayzen.ht',
            ...
            if (resetHour === 6) {
                ...
                const processedData = results
                    ...
                    .map(item => {
                        ...
                        return {
                            id: item.profile.id,
                            name: cached.name || item.profile.name,
