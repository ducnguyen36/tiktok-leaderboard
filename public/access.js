...
(() => {
 ...
 function renderPair(){
  ...
  $('pair-qr').src='/auth/pair-qr?code='+encodeURIComponent(pair.code);$('pair-qr').alt=t('scanQr');
 ...
 function render(){
  ...
  $('google-login').href=scannedPair?'/auth/google?pair='+encodeURIComponent(scannedPair):'/auth/google';
 ...
 $('pair-qr').onload=()=>{$('pair-qr-error').hidden=true};$('pair-qr').onerror=()=>{$('pair-qr-error').hidden=false};
